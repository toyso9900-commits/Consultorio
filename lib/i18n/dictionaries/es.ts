export const es = {
  ...
  nutrition: {
    title: "Registro y Análisis de Comidas",
    ...
    saving: "Guardando...",
    adjustAndConfirm: "Ajustar y Confirmar",
    adjusting: "Ajustando...",
    ...
    referenceDetected: "Referencia detectada",
  ...
  patientProfile: {
    ...
    saveAndViewProgress: "Guardar Cambios y Ver Progreso",
    saving: "Guardando...",
    ...
    healthCenterTitle: "Centro de Perfil y Salud",
    healthCenterSubtitle: "Gestioná tu información y seguimiento.",
    bmiLabel: "IMC",
    generalProgress: "PROGRESO GENERAL",
    completedDays: "{count} días completados",
  ...
  professionalClients: {
    ...
    healthSummaryTitle: "Resumen de Salud - {name}",
    registrationDate: "Fecha de Registro",
    sendMessage: "Enviar Mensaje",
    assignRoutine: "Asignar Rutina",
    progressGalleryTitle: "Galería de Progreso (Fotos)",
    photoTag: "Fotos",
    mealJournalTitle: "Diario Alimenticio (Comidas)",
    healthMetaWeight: "Peso",
    healthMetaBmi: "IMC",
    healthMetaHeight: "Altura",
    healthMetaAge: "Edad",
    ...
    placeholderMeal4: "Merienda: Yogur con frutos secos",
    placeholderMeal5: "Desayuno: Avena con frutas",
    placeholderMeal6: "Almuerzo: Ensalada de quinoa",
  },
  ...
  patientSubscription: {
    ...
    messageCta: "Mandar Mensaje",
    appointmentCta: "Agendar Cita",
    backToExperts: "Volver a la Guía de Expertos",
  },
  patientRoutine: {
    title: "Mi Rutina",
    subtitle: "Seguí tu plan diario y mantené la racha.",
    ...
    freePlanIncluded: "Plan básico incluido para todos los pacientes.",
    ...
    noRoutineForProfessional: "Todavía no hay una rutina para este profesional.",
    byProfessional: "de {name}",
    ...
    mealsProgress: "{count}/{goal} comidas registradas hoy",
    ...
    weekStripLabel: "Tu semana",
    weekDaysShort: "L,M,X,J,V,S,D",
    dayStateComplete: "Día completo",
    dayStatePartial: "Día con progreso parcial",
    dayStateEmpty: "Día sin actividad",
    dayStateFuture: "Día futuro",
    activeProfessional: "Profesional Activo",
    switchToFree: "Cambiar a Versión Gratuita",
    otherProfessionals: "Resumen de Otras Profesionales Activos",
    viewDetail: "[Ver Detalle]",
    dailyHabits: "Hábitos Diarios",
    weeklyView: "Vista semanal",
    freeChecklistWalk: "Caminar 30 min",
    freeChecklistHydration: "Hidratación (8 vasos)",
    freeChecklistMeals: "3 comidas balanceadas",
    routineStatusActive: "Rutina {specialty} Activa",
    routineStatusNone: "Sin rutina publicada",
    professionalTypeNutrition: "Nutricional",
    professionalTypeTraining: "Entrenamiento",
    professionalTypeBoth: "Integral",
  },
  ...
  appointments: {
    ...
    meeting: {
      ...
      save: "Guardar link",
      saving: "Guardando...",
      saved: "Link de la reunión guardado.",
      join: "Unirse a la reunión",
      joinGoogleMeet: "Unirse a la Reunión (Google Meet)",
      pending: "El profesional aún no agregó el link de la reunión.",
    },
  },
} as const;
