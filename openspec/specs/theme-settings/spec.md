...
### REQ-013 — Chart colors MUST use semantic CSS variables
...
### REQ-014 — Chart components MUST re-render on theme change
...
### REQ-015 — Gradient IDs MUST be unique per chart instance
...
- [x] Switching theme updates chart colors immediately in light and dark modes.
- [x] `system` mode follows OS changes after navigating between App Router routes.
- [x] Theme persistence and first-paint behavior remain unchanged.
